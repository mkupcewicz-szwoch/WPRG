<?php
    ...
    if(isset($_POST['submit']) AND isset($_GET['post_id'])) {
            ...
            $insert = $conn->prepare("INSERT INTO comments (post_id, user_id, comment) 
    ...
    comments.post_idt AS id_post_comment, comments.user_id
    AS user_id, comments.comment AS comment, 
